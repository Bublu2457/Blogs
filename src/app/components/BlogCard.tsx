...
export default function BlogCard({ blog }: { blog: any }) {
  return (
    <div className="p-4 bg-purple-300 rounded-lg shadow-sm hover:shadow-md transition">
      ...
      <div className="flex items-center justify-between mt-3 text-xs text-red-400">
